<div class="page-content-wrapper">
	<div class="page-content">
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
			<form role="add-project" action="{{url('admin/project')}}" method="POST" class="horizontal-form">
				<div class="form-body">
						{{csrf_field()}}
				...
				<div class="form-actions right">
					...
					<button type="button" data-request="ajax-submit" data-target='[role="add-project"]' class="btn blue"><i class="fa fa-check"></i> Save</button>
				</div>
			</form>
			<!-- END FORM-->
		</div>		
